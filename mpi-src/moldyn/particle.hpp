...
//particle(){}
    particle(double xcoord, double ycoord, double zcoord, double xvelocity,
    ...
    void force(double side, double rcoff, int mdsize, int x) {
    ...
    double velavg(double vaverh, double h) {

        double velt;
        double sq;

        sq = sqrt(xvelocity * xvelocity + yvelocity * yvelocity
                + zvelocity * zvelocity);
